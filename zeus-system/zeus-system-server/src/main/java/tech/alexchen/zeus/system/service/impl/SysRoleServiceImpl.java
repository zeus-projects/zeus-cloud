...
import tech.alexchen.zeus.system.convert.SysRoleConverter;
import tech.alexchen.zeus.system.entity.SysMenu;
import tech.alexchen.zeus.system.entity.SysRole;
import tech.alexchen.zeus.system.entity.SysRoleMenu;
import tech.alexchen.zeus.system.mapper.SysMenuMapper;
import tech.alexchen.zeus.system.mapper.SysRoleMapper;
import tech.alexchen.zeus.system.mapper.SysRoleMenuMapper;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public Long saveRole(SysRoleSaveDTO dto) {
        if (roleMapper.isRoleNameExists(dto.getName(), null)) {
            throw new ResponsiveRuntimeException(SystemResponseCode.SYS_ROLE_NAME_DUPLICATE);
        }
