package tech.alexchen.zeus.system.service.impl;
...
import tech.alexchen.zeus.system.api.bo.SysDeptRoleBO;
import tech.alexchen.zeus.system.api.constant.SystemResponseCode;
...
import tech.alexchen.zeus.system.convert.SysUserConverter;
import tech.alexchen.zeus.system.entity.SysUser;
import tech.alexchen.zeus.system.entity.SysUserDeptRole;
import tech.alexchen.zeus.system.mapper.SysUserDeptRoleMapper;
import tech.alexchen.zeus.system.mapper.SysUserMapper;
import tech.alexchen.zeus.system.service.SysRoleService;
import tech.alexchen.zeus.system.service.SysUserService;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public Long saveUser(@Valid SysUserSaveDTO dto) {
        if (sysUserMapper.isUsernameExists(dto.getUsername())) {
            throw new ResponsiveRuntimeException(SystemResponseCode.SYS_USERNAME_DUPLICATE);
        }
        if (sysUserMapper.isUserPhoneExists(dto.getPhone())) {
            throw new ResponsiveRuntimeException(SystemResponseCode.SYS_USER_PHONE_DUPLICATE);
        }
        // 保存用户信息
