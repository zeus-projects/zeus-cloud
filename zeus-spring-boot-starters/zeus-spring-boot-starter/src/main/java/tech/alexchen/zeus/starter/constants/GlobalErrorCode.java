package tech.alexchen.zeus.starter.constants;
...
public interface GlobalErrorCode {
    ...
    ErrorCode CLIENT_ERROR = new ErrorCode("A0001", "用户端错误");

    ErrorCode SERVER_ERROR = new ErrorCode("B0001", "服务端错误");

    ErrorCode TPS_ERROR = new ErrorCode("C0001", "调用第三方服务出错");
